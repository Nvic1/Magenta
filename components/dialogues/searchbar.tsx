...
export const SearchBar = () => {
  ...
  return (
    <>
        <button onClick={OpenDialogue} className='absolute flex px-4 py-2 bg-zinc-50 rounded-lg border w-80 items-center space-x-4 hover:bg-stone-300 hover:border-slate-400 cursor-pointer'>
            <span>
            ...
            <span className="text-base text-slate-500">Eg: Book ID, Book Name</span>
        </button>    
                ...
                <Dialog.Panel className="absolute px-8 py-6 top-0 mt-20 transform overflow-hidden rounded-xl bg-white p-6  align-middle transition-all">
                    ...
                    <div className="flex flex-col rounded-xl w-80 space-y-4">
                        ...
                        <div className="flex flex-col">
                            <div className="flex px-6 py-4 items-center justify-normal">
